...
from court.forms import CourtForm, ReservationForm
...
class CourtTest(TestCase):
    ...
    def test_valid_form(self):
        ...
        data ={
            'name':'nombre','width':'100.00','length':'100.00','description':'descripcion',
            'avaible':'Si','price':'100.00',
            'image':image
        }
        form = CourtForm(data=data, files={'image':image})
    ...
    def test_invalid_form(self):
        ...
        data ={
            'name':'','width':'100.00','length':'100.00','description':'descripcion',
            'avaible':'Si','price':'100.00',
            'image':image
        }
        form = CourtForm(data=data, files={'image':image})
...
class ReservationTest(TestCase):
    ...
    def test_valid_form(self):
        ...
        data ={
            'user':r.user.pk,'court':r.court.pk,'date':r.date,'hour':r.hour,'duration':r.duration,
            'cost':r.cost
        }
