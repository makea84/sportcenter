...
diccionario_pista ={
    ...
    'avaible':'Si','price':'100.00','image':image
}
...
class TestClassroom(LiveServerTestCase):
    ...
    def test_create_court(self):
        ...
        self.selenium.find_element_by_id("pistas").click()
        self.selenium.implicitly_wait(10)
        formulario = self.selenium.find_element_by_id("crear-pista-form")
        ...
        price = formulario.find_element_by_id("id_price")
        price.send_keys(Keys.CONTROL + "a")
        price.send_keys(Keys.DELETE)
        price.send_keys("100.00")
    ...
    def test_change_court(self):
        ...
        self.selenium.implicitly_wait(10)
        self.selenium.find_element_by_id("pistas").click()
        formularios = self.selenium.find_elements_by_class_name("formulario-modificar-pista")
        formularios[0].submit()
        self.selenium.implicitly_wait(10)
        formulario= self.selenium.find_element_by_id("modificar-pista-form")
        name = formulario.find_element_by_id("id_name")
        name.send_keys(Keys.CONTROL + "a")
        name.send_keys(Keys.DELETE)
        ...
        self.assertEquals(currentURL,"http://localhost:8080/sportcenter/pistas/todas_pistas/")
    ...
    def test_create_reservation(self):
        ...
        self.selenium.find_element_by_id("pistas").click()
        self.selenium.implicitly_wait(10)
        formulario = self.selenium.find_element_by_id("crear-reserva-form")
        name = formulario.find_element_by_id("id_name")
        name.send_keys(Keys.CONTROL + "a")
        name.send_keys(Keys.DELETE)
        name.send_keys("nombre")
